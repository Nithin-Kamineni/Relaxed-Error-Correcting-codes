...
for sle_layerrs in range(110,122+1):
    ...
    select_layers = [i for i in range(sle_layerrs)]
    ...
    print('keys[l]:',keys[sle_layerrs])
    print(f"\n[Test accuracy] {acc:.2f}% on {dataset_argument} sle_layerrs: {sle_layerrs}")
